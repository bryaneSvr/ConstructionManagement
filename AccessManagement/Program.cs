...
using AccessManagement.SwaggerHelper;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "API for managing Access projects (Version 1.0)"
    });
    ...
    options.SwaggerDoc("v2", new OpenApiInfo
    {
        Version = "v2",
        Title = "Access Management API",
        Description = "API for managing Access projects (Version 2.0)"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "Access Management API v1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "Access Management API v2");
    });
}
